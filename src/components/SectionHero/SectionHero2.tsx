        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44">
          ...
          >
            <div className="space-y-5 sm:space-y-6">
              <span className="text-slate-100 text-shadow-outline md:text-shadow-none nc-SectionHero2Item__subheading block text-base md:text-xl lg:text-slate-700 font-medium">
                {item.subHeading}
              </span>
              <h2 className="text-white lg:text-slate-900 text-shadow-outline lg:text-shadow-none nc-SectionHero2Item__heading font-semibold text-3xl sm:text-4xl md:text-5xl xl:text-6xl 2xl:text-7xl !leading-[114%] ">
                {item.heading}
              </h2>
            </div>
          ...
          <div className="mt-10 lg:mt-0 lg:absolute end-0 rtl:-end-28 bottom-0 top-0 w-[600px] max-w-2xl xl:max-w-3xl 2xl:max-w-4xl">
            <Image
              fill
              sizes="(max-width: 768px) 100vw, 50vw"
